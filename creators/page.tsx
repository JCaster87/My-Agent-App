...
const templates = [
    { key: 'newsletter', name: 'Newsletter Draft', blurb: 'Issue outline + 2 sections fully written.', sampleTitle: 'Subject', sampleBody: '3 ways to grow without paid ads'},
    { key: 'course', name: 'Course Outline Builder', blurb: 'Syllabus + lesson objectives.', sampleTitle: 'Modules', sampleList: ['Mindset fundamentals', 'Audience research', 'Offer design']},
    { key: 'social', name: 'Daily Social Pack', blurb: '5 posts with hooks + CTAs.', sampleTitle: 'Hooks', sampleList: ['I built a $1k/mo system by...', 'Most people overcomplicate...', 'Steal my 10-minute template...']}
  ];
